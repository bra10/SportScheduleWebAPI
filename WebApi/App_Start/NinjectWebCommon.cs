...
namespace WebApi.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            Entities dbCtx = new Entities();
            kernel.Bind<IUnitOfWork>().ToConstructor(_ => new UnitOfWork(dbCtx));
            kernel.Bind<IRepository>().ToConstructor(_ => new Repository<DbContext>(dbCtx));
        }        
    }
}
